...
.placeinfov {width:200px;border-radius:6px;border: 1px solid #ccc;border-bottom:2px solid #ddd;padding-bottom: 10px;background: #fff;float:left;margin-right: 10px; }
.placeinfov_wrap {position:static;margin-top:20px; bottom:28px;width:100%;}
...
<a href="#" onclick="submitForm()"><img src="button/z33.png" style="margin-top: 2.1%"/> </a>
