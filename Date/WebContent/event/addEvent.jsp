...
<body>
<form method="post" name="addEvent" enctype="multipart/form-data" action="eventTeb.nhn">
<table border="1" width="500" cellpadding="0" cellspacing="0" align="center"> 
    <tr height="30"> 
     ...
     <tr>
      ...
      <td align="center"><input type="file" name="upload1"></td>
    </tr>
    <tr>
      <td align="center" width="100">이벤트 상세 이미지</td>
      <td align="center"><input type="file" name="upload2"></td>
    </tr>
     <tr>
      <td align="center" width="100">시작 날짜</td>
      <td align="center"><input type="text" id="start_day" name="sdate" class="forms" style="width:80px;" /> </td>
    </tr>
     <tr>
      <td align="center" width="100">종료 날짜</td>
      <td align="center" ><input type="text" id="end_day" name="edate" class="forms" style="width:80px;"  />
      <a href="#" onclick="miniSetCalendar(event,'start_day','end_day');return false;">[검색달력]</a></td>
    </tr>
