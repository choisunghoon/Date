...
<form id="write" name="write" method="post" enctype="multipart/form-data" action="couple.nhn?chk=1" >
...
<button type="submit" onsubmit="callrefresh('upload2.nhn?couplename=${couplename }')">등록</button>
