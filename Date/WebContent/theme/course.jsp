...
<div class="gallery"> 
  <ul>
    ...
    <c:forEach var="courseList" items="${courseList}">  
     <c:if test="${(i%3)!=0}">
      <li><a href="place.nhn?ctg_num=${ctg_num}&cos_num=${courseList.cos_num}"><img src="${courseList.cos_img}" alt=""></a><center>${courseList.cos_name}</center></li>
     </c:if>
     <c:if test="${(i%3)==0}">
      <li class="last"><a href="place.nhn?ctg_num=${ctg_num}&cos_num=${courseList.cos_num}"><img src="${courseList.cos_img}" alt=""></a><center>${courseList.cos_name}</center></li>
     </c:if>
